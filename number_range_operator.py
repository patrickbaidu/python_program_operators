...
while True:
    try:
        ...
        if input_first_number > input_second_number:
            if input_second_number_increment == input_first_number:
                print(f'{color.red}There are no in-between numbers, Please Try Again{color.end}')
            
            else:
                for between_number in range(input_second_number_increment, input_first_number):
                    between_number_list.append(between_number)
                
                between_number_list.reverse()
                ...
                print(f'The numbers between {input_first_number_colored} and {input_second_number_colored} = {number_list}')
                
                break
        
        elif input_first_number < input_second_number:
            if input_first_number_increment == input_second_number:
                print(f'{color.red}There are no in-between numbers, Please Try Again{color.end}')
